...
export default function B2BRequestsList() {
    ...
    const fetchRequests = async (force = false) => {
        ...
        try {
            ...
            // Fetch everything and filter locally for performance
            const url = `${API_BASE_URL}/b2b/requests`;
            ...
            if (data.success) {
                ...
                cachedRequests = fetchedRequests;
        ...
        <div className="p-6">
            ...
            <div className="mb-6 flex justify-between items-start">
                ...
                <button
                    ...
                    disabled={loading}
                    className="flex items-center gap-2 px-4 py-2 bg-indigo-50 text-indigo-600 font-bold rounded-xl hover:bg-indigo-100 transition-colors disabled:opacity-50"
                >
