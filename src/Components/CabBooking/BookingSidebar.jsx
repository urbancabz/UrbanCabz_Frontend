...
export default function BookingSidebar({ from, to, pickupCoords, dropCoords, pickupDate, pickupTime, onDistanceCalculated }) {
  ...
  return (
    <div className="bg-white border-gray-100 shadow-lg rounded-2xl border p-3 sm:p-5 lg:max-h-[calc(100vh-8rem)] lg:overflow-y-auto transition-colors duration-300">
      {/* Map Preview */}
      <div className="h-32 sm:h-48 rounded-xl mb-3 overflow-hidden bg-gray-100 border-gray-200 relative border">
        {loading ? (
      ...
      {tripMetrics.distanceKm && (
        <div className="mb-3 p-2.5 sm:p-4 rounded-xl border bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
      ...
      <div className="space-y-4 sm:space-y-5">
        <div>
          ...
          <div className="space-y-2.5 sm:space-y-3">
            {/* Pickup Location */}
            <div className="flex gap-2.5 p-2.5 sm:p-4 rounded-xl border transition-colors bg-emerald-50 border-emerald-200 hover:border-emerald-300">
            ...
            {/* Drop Location */}
            <div className="flex gap-2.5 p-2.5 sm:p-4 rounded-xl border transition-colors bg-red-50 border-red-200 hover:border-red-300">
        ...
        <div className="border-t border-gray-100 pt-3 sm:pt-4 space-y-2 sm:space-y-3">
          ...
          <div className="flex items-center justify-between text-xs sm:text-base">
            ...
            <div className="font-semibold text-slate-900">{pickupTime || "—"}</div>
          </div>
        </div>
      </div>
    </div>
